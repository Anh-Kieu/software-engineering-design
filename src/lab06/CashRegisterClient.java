...
public class CashRegisterClient {
    ...
    public static void main(String[] args) {
        ...
        CashRegister reg1 = new CashRegister(), reg2 = new CashRegister("Register 2");
        ...
        System.out.printf("reg1: reg1.collectPayment(10), result: $7.05 ACTUAL = $%.2f%n", reg1.collectPayment(10));
        System.out.println(reg1);
        ...
        System.out.printf("reg1.collectPayment($42.45) = 0.0. ACTUAL = $%.2f%n", reg1.collectPayment(42.45));
        System.out.println(reg1);
